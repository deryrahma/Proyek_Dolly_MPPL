              ...
              <?php
                ...
                if($result)
                {
                    while($row = mysql_fetch_array($result))
                    {
                      ...
                      echo "<td>
                      <center>
                      <a href=\"mh_penilaian_harian.php?id_anak=" . $row['ID_ANAK'] . "&&id_pelatihan=" . $id_pelatihan . "&&jadwal_pelatihan=" . $jadwal_pelatihan . "\"><i class=\"glyphicon glyphicon-list-alt\"></i></a></center></td></tr>\n\t";
                    }
                }
                else {
